...
namespace OsuSharp.Interfaces
{
    public interface IOsuApi
    {
        ...
        ///     <see cref="Beatmap" />
        /// </returns>
        Beatmap GetBeatmap(ulong beatmapId, BeatmapType bmType = BeatmapType.ByDifficulty,
        ...
        ///     <see cref="Beatmap" />
        /// </returns>
        Task<Beatmap> GetBeatmapAsync(ulong beatmapId, BeatmapType bmType = BeatmapType.ByDifficulty,
            GameMode gameMode = GameMode.Standard);
        ...
        ///     <see cref="Beatmap" />
        /// </returns>
        Task<Beatmap> GetBeatmapAsync(ulong beatmapId, BeatmapType bmType, GameMode gameMode,
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<Beatmap>> GetBeatmapsByCreatorAsync(string username, GameMode gameMode = GameMode.Standard,
            int limit = 500);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<Beatmap>> GetBeatmapsByCreatorAsync(string username, GameMode gameMode, int limit,
            CancellationToken cancellationToken);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        List<Beatmap> GetBeatmaps(ulong id, BeatmapType bmType = BeatmapType.ByBeatmap,
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<Beatmap>> GetBeatmapsAsync(ulong id, BeatmapType bmType = BeatmapType.ByBeatmap,
            GameMode gameMode = GameMode.Standard, int limit = 500);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<Beatmap>> GetBeatmapsAsync(ulong id, BeatmapType bmType, GameMode gameMode, int limit,
            CancellationToken cancellationToken);
        ...
        ///     <see cref="Score" />
        /// </returns>
        Task<Score> GetScoreByUsernameAsync(ulong beatmapid, string username, GameMode gameMode,
            CancellationToken cancellationToken);
        ...
        ///     <see cref="Score" />
        /// </returns>
        Task<Score> GetScoreByUseridAsync(ulong beatmapid, ulong userid, GameMode gameMode,
            CancellationToken cancellationToken);
        ...
        ///     <see cref="Score" />
        /// </returns>
        Task<List<Score>> GetScoresAsync(ulong beatmapid, GameMode gameMode, int limit,
            CancellationToken cancellationToken);
        ...
        ///     <see cref="BeatmapScores" />
        /// </returns>
        Task<BeatmapScores> GetScoresAndBeatmapAsync(ulong beatmapid, GameMode gameMode = GameMode.Standard,
            int limit = 50);
        ...
        ///     <see cref="BeatmapScores" />
        /// </returns>
        Task<BeatmapScores> GetScoresAndBeatmapAsync(ulong beatmapid, GameMode gameMode, int limit,
            CancellationToken cancellationToken);
        ...
        /// </returns>
        BeatmapScoresUsers GetScoresWithUsersAndBeatmap(ulong beatmapid, GameMode gameMode = GameMode.Standard,
            int limit = 50);
        ...
        ///     <see cref="BeatmapScoresUsers" />
        /// </returns>
        Task<BeatmapScoresUsers> GetScoresWithUsersAndBeatmapAsync(ulong beatmapid,
        ...
        ///     <see cref="BeatmapScoresUsers" />
        /// </returns>
        Task<BeatmapScoresUsers> GetScoresWithUsersAndBeatmapAsync(ulong beatmapid, GameMode gameMode, int limit,
            CancellationToken cancellationToken);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<UserBest>> GetUserBestByUsernameAsync(string username, GameMode gameMode = GameMode.Standard,
            int limit = 10);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<UserBest>> GetUserBestByUsernameAsync(string username, GameMode gameMode, int limit,
            CancellationToken cancellationToken);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        List<UserBestBeatmap> GetUserBestAndBeatmapByUsername(string username, GameMode gameMode = GameMode.Standard,
            int limit = 10);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<UserBestBeatmap>> GetUserBestAndBeatmapByUsernameAsync(string username, GameMode gameMode, int limit,
            CancellationToken cancellationToken);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<UserBest>> GetUserBestByUseridAsync(ulong userid, GameMode gameMode = GameMode.Standard,
            int limit = 10);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<UserBest>> GetUserBestByUseridAsync(ulong userid, GameMode gameMode, int limit,
            CancellationToken cancellationToken);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        List<UserBestBeatmap> GetUserBestAndBeatmapByUserid(ulong userid, GameMode gameMode = GameMode.Standard,
            int limit = 10);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<UserBestBeatmap>> GetUserBestAndBeatmapByUseridAsync(ulong userid,
            GameMode gameMode = GameMode.Standard, int limit = 10);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<UserBestBeatmap>> GetUserBestAndBeatmapByUseridAsync(ulong userid, GameMode gameMode, int limit,
            CancellationToken cancellationToken);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<UserRecent>> GetUserRecentByUsernameAsync(string username, GameMode gameMode = GameMode.Standard,
            int limit = 10);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<UserRecent>> GetUserRecentByUsernameAsync(string username, GameMode gameMode, int limit,
            CancellationToken cancellationToken);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<UserRecentBeatmap>> GetUserRecentAndBeatmapByUsernameAsync(string username, GameMode gameMode,
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<UserRecent>> GetUserRecentByUseridAsync(ulong userid, GameMode gameMode = GameMode.Standard,
            int limit = 10);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<UserRecent>> GetUserRecentByUseridAsync(ulong userid, GameMode gameMode, int limit,
            CancellationToken cancellationToken);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        List<UserRecentBeatmap> GetUserRecentAndBeatmapByUserid(ulong userid, GameMode gameMode = GameMode.Standard,
            int limit = 10);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<UserRecentBeatmap>> GetUserRecentAndBeatmapByUseridAsync(ulong userid,
            GameMode gameMode = GameMode.Standard, int limit = 10);
        ...
        ///     <see cref="List{T}" />
        /// </returns>
        Task<List<UserRecentBeatmap>> GetUserRecentAndBeatmapByUseridAsync(ulong userid, GameMode gameMode, int limit,
            CancellationToken cancellationToken);
        ...
        ///     <see cref="Replay" />
        /// </returns>
        Task<Replay> GetReplayByUsernameAsync(ulong beatmapid, string username, GameMode gameMode,
            CancellationToken cancellationToken);
        ...
        ///     <see cref="Replay" />
        /// </returns>
        Task<Replay> GetReplayByUseridAsync(ulong beatmapid, ulong userid, GameMode gameMode,
            CancellationToken cancellationToken);
    }
}